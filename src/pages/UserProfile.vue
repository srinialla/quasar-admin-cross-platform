      ...
      <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
        ...
        <q-card class="card-bg text-white no-shadow" bordered>
          <q-card-section class="text-center bg-transparent">
            ...
            <div class="text-subtitle2 q-mt-lg">by Srini Alla</div>
            <div class="text-h6 q-mt-md">Srini Alla</div>
          </q-card-section>
          <q-card-section>
            <div class="text-body2 text-justify">
              My name is Srini Alla (also known as @srinualla). I noticed myself pulling into programming since 2013,
